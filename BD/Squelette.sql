...
-- Généré le : Dim 25 Septembre 2022 à 18:56
...
(6, 1, 0, 0, 'Connexion', '', 'connecter', 'PEUNC\\Formulaire', 'connecter.php', 'GET', '[]'),
...
(16, 1, 0, 0, 'Connexion', '', 'connecter', 'PEUNC\\Formulaire', 'connecter.php', 'POST', '["CSRF", "utilisateur", "MDP"]');
